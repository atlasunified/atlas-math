...
MODULE_INFO = {'module_id': 'linear_algebra.vectors.vector_operations', 'name': 'Vector Operations', 'topic': 'linear_algebra', 'subtopic': 'vectors.vector_operations', 'difficulty_levels': ['level_1', 'level_2', 'level_3', 'level_4', 'level_5'], 'enabled': True}

INSTRUCTIONS = ['Perform the indicated vector operation. {problem}', 'Add or subtract the vectors. {problem}', 'Compute the resulting vector. {problem}']
