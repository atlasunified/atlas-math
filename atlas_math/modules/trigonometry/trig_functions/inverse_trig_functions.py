...
MODULE_INFO = {
    "module_id": "trigonometry.trig_functions.inverse_trig_functions",
    "name": "Inverse Trig Functions",
    "topic": "trigonometry",
    "subtopic": "trig_functions.inverse_trig_functions",
    "difficulty_levels": ["level_1", "level_2", "level_3", "level_4", "level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = [
    "Evaluate the inverse trig expression in {problem}.",
    "Find the principal value for {problem}.",
    "Use inverse trig definitions to answer {problem}.",
]

ARCSIN = {'-1':'-π/2','-√3/2':'-π/3','-√2/2':'-π/4','-1/2':'-π/6','0':'0','1/2':'π/6','√2/2':'π/4','√3/2':'π/3','1':'π/2'}
ARCCOS = {'-1':'π','-√3/2':'5π/6','-√2/2':'3π/4','-1/2':'2π/3','0':'π/2','1/2':'π/3','√2/2':'π/4','√3/2':'π/6','1':'0'}
ARCTAN = {'-√3':'-π/3','-1':'-π/4','-√3/3':'-π/6','0':'0','√3/3':'π/6','1':'π/4','√3':'π/3'}
...
def _build_problem(rng, difficulty):
    if difficulty in {'level_1','level_2'}:
        fn = 'arcsin' if difficulty == 'level_1' else rng.choice(['arcsin','arccos'])
    else:
        fn = rng.choice(['arcsin','arccos','arctan'])
    table = ARCSIN if fn == 'arcsin' else ARCCOS if fn == 'arccos' else ARCTAN
    value = rng.choice(list(table.keys()))
    problem = f"{fn}({value})"
    answer = table[value]
    meta = {'function': fn, 'input_value': value, 'principal_value': answer}
