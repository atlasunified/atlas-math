...
MODULE_INFO = {
    "module_id": "trigonometry.graphs.asymptotes_and_zeros",
    "name": "Asymptotes and Zeros",
    "topic": "trigonometry",
    "subtopic": "graphs.asymptotes_and_zeros",
...
def _build_problem(rng: random.Random, difficulty: str):
    if difficulty == 'level_1':
        return 'Find the zeros of y = sin(x) on [0, 2π].', '0, π, 2π', {'task': 'zeros', 'function': 'sin'}
    if difficulty == 'level_2':
        return 'Find the zeros of y = cos(x) on [0, 2π].', 'π/2, 3π/2', {'task': 'zeros', 'function': 'cos'}
    if difficulty == 'level_3':
        return 'Find the vertical asymptotes of y = tan(x) on [0, 2π].', 'π/2, 3π/2', {'task': 'asymptotes', 'function': 'tan'}
    if difficulty == 'level_4':
        return 'Find the vertical asymptotes of y = sec(x) on [0, 2π].', 'π/2, 3π/2', {'task': 'asymptotes', 'function': 'sec'}
    return 'Find the vertical asymptotes of y = csc(x) on [0, 2π].', '0, π, 2π', {'task': 'asymptotes', 'function': 'csc'}
