...
MODULE_INFO = {
    "module_id": "trigonometry.equations.linear_trig_forms",
    "name": "Linear Trig Forms",
    "topic": "trigonometry",
    "subtopic": "equations.linear_trig_forms",
...
def _build_problem(rng: random.Random, difficulty: str):
    if difficulty == 'level_1':
        return 'Solve 2sin(x) - 1 = 0 for 0 ≤ x < 2π.', 'π/6, 5π/6', {'task': 'linear_form', 'function': 'sin'}
    if difficulty == 'level_2':
        return 'Solve 3cos(x) + 3 = 0 for 0 ≤ x < 2π.', 'π', {'task': 'linear_form', 'function': 'cos'}
    if difficulty == 'level_3':
        return 'Solve tan(x) - 1 = 0 for 0 ≤ x < 2π.', 'π/4, 5π/4', {'task': 'linear_form', 'function': 'tan'}
    if difficulty == 'level_4':
        return 'Solve 4sin(x) = 2√3 for 0 ≤ x < 2π.', 'π/3, 2π/3', {'task': 'linear_form', 'function': 'sin'}
    return 'Solve 2cos(x) - √2 = 0 for 0 ≤ x < 2π.', 'π/4, 7π/4', {'task': 'linear_form', 'function': 'cos'}
