...
MODULE_INFO = {
    "module_id": "trigonometry.equations.trig_equations_unit_circle",
    "name": "Trig Equations from Unit Circle",
    "topic": "trigonometry",
    "subtopic": "equations.trig_equations_unit_circle",
...
ALL_CASES = {
    'sin': [('√3/2', 'π/3, 2π/3'), ('-√3/2', '4π/3, 5π/3'), ('√2/2', 'π/4, 3π/4')],
    'cos': [('√3/2', 'π/6, 11π/6'), ('-√3/2', '5π/6, 7π/6'), ('√2/2', 'π/4, 7π/4')],
    'tan': [('√3', 'π/3, 4π/3'), ('-√3', '2π/3, 5π/3'), ('√3/3', 'π/6, 7π/6')],
}


def _build_problem(rng: random.Random, difficulty: str):
    func = 'sin' if difficulty in ('level_1','level_2') else ('cos' if difficulty in ('level_3','level_4') else rng.choice(['sin','cos','tan']))
    val, sol = rng.choice(ALL_CASES[func])
    return f'Use the unit circle to solve {func}(x) = {val} for 0 ≤ x < 2π.', sol, {'task': 'unit_circle_solve', 'function': func, 'value': val}
