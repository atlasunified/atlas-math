...
MODULE_INFO = {
    "module_id": "probability.counting.fundamental_counting_principle",
    "name": "Fundamental Counting Principle",
    "topic": "probability",
    "subtopic": "counting.fundamental_counting_principle",
    "difficulty_levels": ["level_1", "level_2", "level_3", "level_4", "level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = [
    "Use the fundamental counting principle in {problem}.",
