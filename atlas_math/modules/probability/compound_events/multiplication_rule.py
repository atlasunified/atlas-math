...
MODULE_INFO = {
    "module_id": "probability.compound_events.multiplication_rule",
    "name": "Multiplication Rule",
    "topic": "probability",
    "subtopic": "compound_events.multiplication_rule",
...
INSTRUCTION_TEMPLATES = [
    ...
    "Find the joint probability in {problem}.",
    "Evaluate {problem}.",
]
...
def _build_problem(rng: random.Random, difficulty: str):
    ...
    metadata = {"p_a": f"{p_num}/{p_den}", "p_b": f"{q_num}/{q_den}", "independent": True}
