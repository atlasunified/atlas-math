...
MODULE_INFO = {
    "module_id": "statistics.descriptive.interquartile_range",
    "name": "Interquartile Range",
    "topic": "statistics",
    "subtopic": "descriptive.interquartile_range",
    "difficulty_levels": ["level_1","level_2","level_3","level_4","level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = ["Find the interquartile range of {problem}.","Compute the IQR for {problem}.","Calculate Q3 - Q1 for {problem}."]
...
def _build_problem(rng: random.Random, difficulty: str):
    ...
    q1, q3 = _q1_q3(s)
    iqr = q3 - q1
    ans = str(int(iqr)) if abs(iqr - int(iqr)) < 1e-9 else f"{iqr:.1f}"
    metadata = {"sample_size": len(data), "q1": q1, "q3": q3}
