...
MODULE_INFO = {
    "module_id": "statistics.descriptive.standard_deviation",
    "name": "Standard Deviation",
    "topic": "statistics",
    "subtopic": "descriptive.standard_deviation",
    "difficulty_levels": ["level_1","level_2","level_3","level_4","level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = ["Find the standard deviation of {problem}.","Compute the population standard deviation for {problem}.","Calculate the standard deviation for {problem}."]
...
def _build_problem(rng: random.Random, difficulty: str):
    ...
    sd = math.sqrt(var)
    ans = f"{sd:.2f}".rstrip("0").rstrip(".")
    metadata = {"sample_size": len(data), "variance_type": "population"}
