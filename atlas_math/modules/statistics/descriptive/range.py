...
MODULE_INFO = {
    "module_id": "statistics.descriptive.range",
    "name": "Range",
    "topic": "statistics",
    "subtopic": "descriptive.range",
    "difficulty_levels": ["level_1","level_2","level_3","level_4","level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = ["Find the range of {problem}.","Compute the range for {problem}.","Calculate max minus min for {problem}."]
...
def _build_problem(rng: random.Random, difficulty: str):
    ...
    metadata = {"sample_size": len(data), "minimum": min(data), "maximum": max(data)}
