...
MODULE_INFO = {
    "module_id": "statistics.descriptive.variance",
    "name": "Variance",
    "topic": "statistics",
    "subtopic": "descriptive.variance",
    "difficulty_levels": ["level_1","level_2","level_3","level_4","level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = ["Find the variance of {problem}.","Compute the population variance for {problem}.","Calculate the variance for {problem}."]
...
def _build_problem(rng: random.Random, difficulty: str):
    ...
    ans = str(int(var)) if abs(var - int(var)) < 1e-9 else f"{var:.2f}".rstrip("0").rstrip(".")
