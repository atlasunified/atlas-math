...
MODULE_INFO = {
    "module_id": "statistics.descriptive.five_number_summary",
    "name": "Five Number Summary",
    "topic": "statistics",
    "subtopic": "descriptive.five_number_summary",
    "difficulty_levels": ["level_1","level_2","level_3","level_4","level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = ["Find the five-number summary of {problem}.","Compute the five-number summary for {problem}.","Determine min, Q1, median, Q3, and max for {problem}."]
...
def _build_problem(rng: random.Random, difficulty: str):
    ...
    metadata = {"sample_size": len(data), "sorted": s}
