...
MODULE_INFO = {
    "module_id": "statistics.data_displays.frequency_tables",
    "name": "Frequency Tables",
    "topic": "statistics",
    "subtopic": "data_displays.frequency_tables",
    "difficulty_levels": ["level_1","level_2","level_3","level_4","level_5"],
    "enabled": True,
}

INSTRUCTION_TEMPLATES = ["Create the frequency table for {problem}.","Find the frequencies for {problem}.","Tabulate the data in {problem}."]
