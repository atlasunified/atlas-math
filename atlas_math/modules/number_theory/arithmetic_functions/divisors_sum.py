...
MODULE_INFO = {
    "module_id": "number_theory.arithmetic_functions.divisors_sum",
    "name": "Divisors Sum",
    "topic": "number_theory",
    "subtopic": "arithmetic_functions.divisors_sum",
    "difficulty_levels": ["level_1","level_2","level_3","level_4","level_5"],
    "enabled": True,
}

INSTRUCTIONS = [
    "Find the sum of the positive divisors of {problem}.",
    "Compute σ(n) for {problem}.",
]
